    ...
    <header className="sticky top-0 z-50 bg-gray-950/80 backdrop-blur border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <img src="/ARTHEN-LOGO-TRANSPARANSI.png" alt="ARTHEN Logo" className="h-8 w-8 rounded-sm" />
        ...
        <nav className="flex items-center gap-6 text-sm">
          ...
          <NavLink to="/docs" className={({isActive}) => isActive ? 'text-white' : 'text-gray-300 hover:text-white'}>Docs</NavLink>
